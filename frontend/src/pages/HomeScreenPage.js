  ...
  const renderPercent = (percent, text) => {
    return (
      <Box
        display="flex"
        alignItems="center"
        flexDirection={mobileColumnFlex}
        mb={1}
        textAlign="center"
      >
    ...
    <>
      <Box>
        <VideoBackground src="/images/pexels-offrideli-14623516.mp4">
          <Box position="relative" left="20px" top="20px" max-width="90vw">
            <img
              alt="lead"
              style={{ maxWidth: 250 }}
              src="/images/svg/logo-FFFFFF.svg"
            />
            <Typography
              sx={{
                fontSize: '16px',
          ...
          <Box position="relative" left="20px" max-width="90vw" color="white">
            <Box
              sx={{
                fontSize: '36px',
                position: 'relative',
        ...
        <Box pt={3} maxWidth={isMobile ? '1200' : '90%'} margin="0 auto">
          <FadeInContent>
            ...
            >
              <Image
                ...
                style={{
                  ...
                  maxHeight: '100%',
                  borderRadius: 12,
                  boxShadow: '15px 15px 12px 7px rgba(0, 0, 0, 0.15)',
                }}
                height={600}
              />
            </Box>
        ...
        >
          ...
          >
            <FadeInContent>
              ...
              {renderPercent(
                80,
                'of students graduate from High School in Oakland.'
              )}
              {renderPercent(
                58,
              ...
              <Box mr={isMobile ? '0' : 5}>
                ...
                <Box display="flex" alignItems="center" mt={4}>
                  ...
                  <Typography ml={1.5} fontSize={22}>
                    {' '}
                    We want every parent to know what their child can qualify
                    for
                  </Typography>
                </Box>
                <Box display="flex" alignItems="center" mt={4}>
                  ...
                  <Typography ml={1.5} fontSize={22}>
                    {' '}
                    Every kid deserves a chance at all opportunities available
                  </Typography>
                </Box>
                <Box display="flex" alignItems="center" mt={4}>
                  <RadioButtonChecked />
                  <Typography ml={1.5} fontSize={22}>
                    {' '}
                    To bridge the gap between information and application
                  </Typography>
                </Box>
                <Box display="flex" alignItems="center" mt={4}>
                  <RadioButtonChecked />
                  <Typography ml={1.5} fontSize={22}>
                    {' '}
                    To break down language barriers and make all information
                    accessible
                  </Typography>
                </Box>
              </Box>
            ...
            >
              <Box ml={isMobile ? '0' : 10}>
                ...
                <Box display="flex" alignItems="center" mt={4}>
                  <RadioButtonChecked />
                  <Typography ml={1.5} fontSize={22}>
                    We add programs as frequent as possible but any user can add
                    any opportunity they know of.
                  </Typography>
                </Box>
                <Box display="flex" alignItems="center" mt={4}>
                  <RadioButtonChecked />
                  <Typography ml={1.5} fontSize={22}>
                    All programs are active, if you see any that aren&apos;t
                    reach out and we&apos;ll remove it
                  </Typography>
                </Box>
                <Box display="flex" alignItems="center" mt={4}>
                  <RadioButtonChecked />
        ...
        <VideoBackground
          src="/pexels-rodnae-productions-8419363.mp4"
          height="75vh"
        >
